...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['submit'])) {
    $updateCmr = $cmr->customerUpdate($_POST, $cmrId);//catch all data $_post
}
?>
        ...
        <div class="section group">
            ...
            <form action="" method="post">
                    <table class="tblone">
                        ...
                        <?php
                        if (isset($updateCmr)) {
                            echo "<tr> <td colspan='2' style='text-align: center;'>".$updateCmr."</td> </tr>";
                        }
                        ?>
                        ...
                        <tr>
                            <td>Zipcode</td>
                            <td><input type="text" name="zip" value="<?= $result['zip']; ?>"></td>
                        </tr>
                        <tr>
                            <td>Country</td>
